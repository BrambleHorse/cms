    ...
    <form id="admin-form" action="/admin.catalog.filter.do" method="post">
        ...
        <table class="admin-input">
            <tr>
                ...
                <td><input type="text" name="catalogCategoryFilterName" class="text-input" value="${catalogCategoryFilter.catalogCategoryFilterName}"></td>
            </tr>
            <tr>
                <td>Позиция:</td>
                <td><input type="text" name="catalogCategoryFilterPosition" class="number-input" value="${catalogCategoryFilter.catalogCategoryFilterPosition}"></td>
            </tr>
            <tr>
                <td></td>
